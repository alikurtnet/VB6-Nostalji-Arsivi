...
| Dosya / Bilgi | Açıklama | Bağlantı |
| :--- | :--- | :--- |
| 📦 **mS-Explorer-Kur (EXE)** | **[Orijinal Windows Kurulum Paketi]** | [İndir](https://github.com/alikurtnet/VB6-Nostalji-Arsivi/releases/download/v1.0.0-Explorer/mS-Explorer-Kur.exe) |
